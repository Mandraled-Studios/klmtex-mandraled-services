<x-admin-layout>
    <x-slot name="pagescript">
        <?php 
            if($product->productable_type == "categories") {
                $maincat = \App\Models\Category::findOrFail($product->productable_id);
                $subcat = (object) array('id' => '');
                $secsubcat = (object) array('id' => '');
            } else if($product->productable_type == "subcategories") {
                $subcat = \App\Models\Subcategory::findOrFail($product->productable_id);
                $maincat = $subcat->category; 
                $secsubcat = (object) array('id' => '');
            } else if($product->productable_type == "secondary_subcategories") {
                $secsubcat = \App\Models\SecondarySubcategory::findOrFail($product->productable_id);
                $subcat = $secsubcat->subcategory; 
                $maincat = $subcat->category; 
            }
        ?>
        <script>
            ...
            // Load Product assigned to - Drop down on page load
            ...
            $(document).ready(function(){
                ...
                // If Product is assigned to main category
                if(choice == "categories") {
                    ...
                    success: function(result) {
                                ...
                                for(res of result) {
                                    ...
                                    if(res['id'] == "<?php echo $product->productable_id; ?>" ) {
                ...
                } // If Product is assigned to subcategory
                    ...
                    success: function(result) {
                                ...
                                $.ajax({
                                    url: '/api/products/choices/subcategories',
                                    type: 'GET',
                                    data: "under="+<?php echo $maincat->id; ?>,
                                    success: function(result) {
                                               
                                                $("#main_category2").html("<option value = '0'> Choose an option </option>");
                                                for(rslt of result) {
                                                    let opt = document.createElement("option");
                                                    $(opt).attr("value", rslt['id']);
                                                    
                                                    if( rslt['id'] == "<?php echo $subcat->id; ?>" ) {
                                                        $(opt).attr("selected", "selected");
                                                    }
                                                    $(opt).html(rslt['name']);
                                                ...
                                                $.ajax({
                                                    url: '/api/products/choices/subcategories',
                                                    type: 'GET',
                                                    data: "under=<?php echo $subcat->id; ?>",
                                                    success: function(ajaxresult) {
                                                                console.log(ajaxresult);
                                                                $("#productable_id").html("<option value = '0'> Choose an option </option>");
                                                                for(rslt of ajaxresult) {
                                                                    let opt = document.createElement("option");
                                                                    $(opt).attr("value", rslt['id']);
                ...
                } // If Product is assigned to secondary sub category
                    ...
                    success: function(result) {
                                ...
                                $.ajax({
                                    ...
                                    success: function(result) {
                                                ...
                                                $.ajax({
                                                    url: '/api/products/choices/secondary-subcategories',
                                                    type: 'GET',
                                                    data: "under=<?php echo $secsubcat->id; ?>",
                                                    success: function(ajaxresult) {
                                                                console.log(ajaxresult);
                                                                $("#productable_id").html("<option value = '0'> Choose an option </option>");
                                                                for(rslt of ajaxresult) {
                                                                    ...
                                                                    if( rslt['id'] == "<?php echo $secsubcat->id; ?>" ) {
                                                                        $(opt).attr("selected", "selected");
                                                                    }
                                                                    $(opt).html(rslt['name']);
                                                                    $("#productable_id").append(opt);
    ...
    <x-dashview>  
        ...
        <x-slot name="breadcrumb">
            ...
            <span> / {{$product->name}} (Edit Product) </span> 
        </x-slot>
        ...
        <div class="w-full h-screen overflow-y-scroll md:flex">
                ...
                <div id="general_subsection" class = "bg-white mb-6 p-4 border border-gray-200 shadow-md">
                    <form action="/products/{{$product->id}}" method = "POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-6">
                            ...
                            <input type="text" name = "name" id = "name" placeholder = "Enter a new product name (eg. Smart Phones)" class = "block mt-1 w-full border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm" value = "{{$product->name}}" required />
                            @if($errors->has('name'))
                        ...
                        <div class="mb-6">
                            ...
                            <textarea name = "short_description" id = "short_description" placeholder = "Enter a short description for product" class = "block mt-1 w-full border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm">{{$product->short_description}}</textarea>
                        ...
                        <div class="mb-6">
                            ...
                            <textarea rows="10" name = "long_description" id = "long_description" placeholder = "Enter a long description for product" class = "block mt-1 w-full border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm">{{$product->long_description}}</textarea>
                        ...
                        <div class="mb-6">
                            ...
                            @if ($product->thumbnail_path != NULL) 
                                <img class="w-40 h-40 object-contain object-center mb-8" src="{{$product->thumbnail_path}}" alt="product-image">
                            @endif
                        ...
                        <div class="mb-6">
                            ...
                            <select name = "tag1" id = "tag1" class = "block mt-1 w-full border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm" required>
                                ...
                                <option value="bestselling" {{$product->tag1 == "bestselling" ? 'selected' : null}}> Best Selling </option>
                                <option value="editorchoice" {{$product->tag1 == "editorchoice" ? 'selected' : null}}> Editor's Choice </option>
                            </select>
                            @if($errors->has('tag1'))
                                <div class="bg-red-200 text-red-700 p-3 mb-6">
                                    <ul>
                        ...
                        <div class="mb-6">
                            ...
                            <select name = "tag2" id = "tag2" class = "block mt-1 w-full border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm" required>
                                <option value="0"> Choose an option </option>
                                <option value="bestselling" {{$product->tag2 == "bestselling" ? 'selected' : null}}> Best Selling </option>
                                <option value="editorchoice" {{$product->tag2 == "editorchoice" ? 'selected' : null}}> Editor's Choice </option>
                            </select>
                            @if($errors->has('tag2'))
                                <div class="bg-red-200 text-red-700 p-3 mb-6">
                                    <ul>
                        ...
                        <div class="mb-6">
                            ...
                            <input type="text" name = "tax_slab" id = "tax_slab" placeholder = "Enter the tax slab of product (eg. 12 for 12%) " class = "block mt-1 w-full border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm" value = "{{$product->tax_slab}}" required />
                        ...
                        <div class="mb-6">
                            ...
                            <div class="relative inline-block w-10 mr-2 align-middle select-none transition duration-200 ease-in">
                                <input type="checkbox" name="allows_questions" id="allows_questions" class="toggle-checkbox absolute block w-6 h-6 rounded-full bg-white border-4 appearance-none" {{$product->allows_questions == 1 ? "checked" : null}} />
                        ...
                        <div class="mb-6">
                            ...
                            <div class="relative inline-block w-10 mr-2 align-middle select-none transition duration-200 ease-in">
                                <input type="checkbox" name="is_active" id="is_active" class="toggle-checkbox absolute block w-6 h-6 rounded-full bg-white border-4 appearance-none cursor-pointer" {{ $product->is_active == 1 ? "checked" : null }} />
                                <label class="toggle-label block overflow-hidden h-6 rounded-full bg-gray-300 cursor-pointer"></label>
                            </div>
                        </div>
                        <div class="mb-6">
                            ...
                            <div class="mb-6">
                                ...
                                <select name = "productable_type" id = "productable_type" class = "block mt-1 w-full border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm" required>
                                    <option value="0"> Choose an option </option>
                                    <option {{ $product->productable_type == "categories" ? 'selected' : null }} value="categories"> Main Category </option>
                                    <option {{ $product->productable_type == "subcategories" ? 'selected' : null }} value="subcategories"> Sub Category </option>
                                    <option {{ $product->productable_type == "secondary_subcategories" ? 'selected' : null }} value="secondary_subcategories"> Secondary Sub Category </option>
                                </select>
                        ...
                        <div class="mb-6">
                            ...
                            <div class="mb-6">
                                ...
                                <input type="text" name = "slug" id = "slug" placeholder = "Enter a slug to show in the URL (eg. smart-phones-and-tablets)" class = "block mt-1 w-full border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm" value = "{{$product->slug}}" required />
                                @if($errors->has('slug'))
                                    <div class="bg-red-200 text-red-700 p-3 mb-6">
                                        <ul>
                            ...
                            <div class="mb-6">
                                ...
                                <input type="text" name = "metatitle" id = "metatitle" placeholder = "Enter a new product metatitle (eg. Smart Phones)" class = "block mt-1 w-full border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm" value = "{{$product->metatitle}}" required />
                            ...
                            <div class="mb-6">
                                ...
                                <input type="text" name = "keywords" id = "keywords" placeholder = "Enter keywords for products" class = "block mt-1 w-full border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm" value = "{{$product->keywords}}" required />
                        ...
                        <div class="mb-6">
                            <input type="submit" name = "submit" class = "px-4 py-2 cursor-pointer text-gray-700 bg-amber-300 hover:bg-amber-400" value="Save Product & Exit">
                    ...
                    <div class="mb-6 border border-gray-200 shadow-md p-3 opacity-30 bg-gray-200">
                        ...
                        <div class="relative inline-block w-10 mr-2 align-middle select-none transition duration-200 ease-in">
                            <input disabled type="checkbox" name="has_variants" id="has_variants" class="toggle-checkbox absolute block w-6 h-6 rounded-full bg-white border-4 appearance-none" {{$product->has_variants == 1 ? "checked" : null}} />
                    ...
                    <div class="mb-6 border border-gray-200 shadow-md p-3 opacity-30 bg-gray-200">
                        ...
                        <div class="relative inline-block w-10 mr-2 align-middle select-none transition duration-200 ease-in">
                            <input disabled type="checkbox" name="is_stock_monitored" id="is_stock_monitored" class="toggle-checkbox absolute block w-6 h-6 rounded-full bg-white border-4 appearance-none" {{$product->is_stock_monitored == 1 ? "checked" : null}} />
                            <label class="toggle-label block overflow-hidden h-6 rounded-full bg-gray-300"></label>
                        </div>
                    ...
                    <div class="mb-6 border border-gray-200 shadow-md p-3 opacity-30 bg-gray-200">
                        ...
                        <div class="relative inline-block w-10 mr-2 align-middle select-none transition duration-200 ease-in">
                            <input disabled type="checkbox" name="has_highlights" id="has_highlights" class="toggle-checkbox absolute block w-6 h-6 rounded-full bg-white border-4 appearance-none" {{$product->has_highlights == 1 ? "checked" : null}} />
                            <label class="toggle-label block overflow-hidden h-6 rounded-full bg-gray-300"></label>
                        </div>
                    ...
                    <div class="mb-6 border border-gray-200 shadow-md p-3 opacity-30 bg-gray-200">
                        ...
                        <div class="relative inline-block w-10 mr-2 align-middle select-none transition duration-200 ease-in">
                            <input disabled type="checkbox" name="has_banner" id="has_banner" class="toggle-checkbox absolute block w-6 h-6 rounded-full bg-white border-4 appearance-none" {{$product->has_banner == 1 ? "checked" : null}} />
                            <label class="toggle-label block overflow-hidden h-6 rounded-full bg-gray-300"></label>
                        </div>
                    ...
                    <div class="mb-6 border border-gray-200 shadow-md p-3 opacity-30 bg-gray-200">
                        ...
                        <div class="relative inline-block w-10 mr-2 align-middle select-none transition duration-200 ease-in">
                            <input disabled type="checkbox" name="has_attributes" id="has_attributes" class="toggle-checkbox absolute block w-6 h-6 rounded-full bg-white border-4 appearance-none" {{$product->has_attributes == 1 ? "checked" : null}} />
                            <label class="toggle-label block overflow-hidden h-6 rounded-full bg-gray-300"></label>
                        </div>
                    ...
                    <div class="mb-6 border border-gray-200 shadow-md p-3 opacity-30 bg-gray-200">
                        ...
                        <div class="relative inline-block w-10 mr-2 align-middle select-none transition duration-200 ease-in">
                            <input disabled type="checkbox" name="has_offers" id="has_offers" class="toggle-checkbox absolute block w-6 h-6 rounded-full bg-white border-4 appearance-none" {{$product->has_offers == 1 ? "checked" : null}} />
                            <label class="toggle-label block overflow-hidden h-6 rounded-full bg-gray-300"></label>
                        </div>
                    ...
                    <div class="mb-6 border border-gray-200 shadow-md p-3 opacity-30 bg-gray-200">
                        ...
                        <div class="relative inline-block w-10 mr-2 align-middle select-none transition duration-200 ease-in">
                            <input disabled type="checkbox" name="has_attachments" id="has_attachments" class="toggle-checkbox absolute block w-6 h-6 rounded-full bg-white border-4 appearance-none" {{$product->has_attachments == 1 ? "checked" : null}} />
                            <label class="toggle-label block overflow-hidden h-6 rounded-full bg-gray-300"></label>
                        </div>
            ...
            <div class = "w-full pt-28 md:w-4/12 sticky top-0"> 
                <x-sidebar_index pid="{{$product->id}}" step="1" newproduct="{{false}}"></x-sidebar_index>
            </div>
        </div>
    </x-dashview>
</x-admin-layout>