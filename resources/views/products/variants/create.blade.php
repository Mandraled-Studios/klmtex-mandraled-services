<x-admin-layout>
    <x-slot name="pagescript">
        <script>
            ...
            // Add Variants
            $("button.add_variant").on("click", function(){
    ...
    <x-dashview>  
        <x-slot name="heading">
            Add Values For Product Variants
        </x-slot>
        ...
        <x-slot name="breadcrumb">
            ...
            <span> / </span> 
            <a href="/products/{{$product->id}}/variants" class = "underline"> Variant Types </a> 
            <span> / Add Variant Values </span>
        </x-slot>
        ...
        <div class="w-full h-screen overflow-y-scroll md:flex">
            <div class = "w-full min-h-screen md:w-8/12">
                ...
                <div class="mb-6 border border-gray-200 shadow-md p-3 bg-gray-200">
                    <label for="has_variants" class = "block mb-2 text-sm"> Type the values for the variants </label>

                    <div id = "variant_subsection" class = "px-4 pb-3 py-9">
                        @livewire('variant-value-form', ['product' => $product])
                                                
                    </div>

                    <div class="py-2 mt-6">
                        <a class="px-4 py-2 cursor-pointer text-white bg-blue-400 hover:bg-blue-500" href="{{route('products.variants.index', ["id" => $product->id])}}"> Go Back To Variation Types </a>
                    </div>
                </div>
