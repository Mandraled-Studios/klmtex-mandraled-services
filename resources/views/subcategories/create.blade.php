<x-admin-layout>
    <x-dashview>  
        ...
        <x-slot name="breadcrumb">
            <a href="/subcategories" class = "underline">Subcategories</a> <span> / Create a new subcategory </span>
        </x-slot>
        ...
        <div class="w-full p-4">
            <form class = "w-full md:w-3/4 px-4" action="/subcategories" method = "POST" enctype="multipart/form-data">
                @csrf
                <div class="mb-6">
                ...
                <div class="mb-6">
                    <label for="isActive" class = "block mb-2 text-sm"> Is Subcategory Visible Under Category In Dropdown? </label>
                ...
                <div class="mb-6">
                    <input type="submit" class = "px-4 py-2 cursor-pointer text-white bg-blue-400 hover:bg-blue-500" value="Create Subcategory">
                </div>
            </form>
        </div>
    </x-dashview>
